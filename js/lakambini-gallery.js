(function () {
  var galleries = {
    frontend: [
      { src: "assets/images/lakambini2026/frontend/home.png", label: "Homepage · Hero & Countdown" },
      { src: "assets/images/lakambini2026/frontend/about.png", label: "About · Candidate Profile" },
      { src: "assets/images/lakambini2026/frontend/program.png", label: "Program · Event Details" },
      { src: "assets/images/lakambini2026/frontend/support.png", label: "Support · GCash Confirmation" },
      { src: "assets/images/lakambini2026/frontend/donors.png", label: "Donors · Wall of Gratitude" }
    ],
    backend: [
      { src: "assets/images/lakambini2026/backend/admin-login.png", label: "Admin Login" },
      { src: "assets/images/lakambini2026/backend/donor-validation.png", label: "Donor Validation Panel" },
      { src: "assets/images/lakambini2026/backend/add-donor.png", label: "Add Donor Manually" },
      { src: "assets/images/lakambini2026/backend/edit-donor.png", label: "Edit Donor Record" },
      { src: "assets/images/lakambini2026/backend/admin-profile.png", label: "Admin Profile & Password" }
    ]
  };
